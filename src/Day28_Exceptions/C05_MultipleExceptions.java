...
public class C05_MultipleExceptions {
    public static void main(String[] args) {
       /*
        ...
        String str="Java'da fazla exception var";
      ...
      //  System.out.println("Array'den istenen index'deki element : " + arr[index]);
        ...
        try { System.out.println("String'den istenen index'deki element : " + str.substring(index, index + 1));
            System.out.println("Array'den istenen index'deki element : " + arr[index]);

        }catch (StringIndexOutOfBoundsException e){
            System.out.println("istenen index String'in sinirlari disinsa");
