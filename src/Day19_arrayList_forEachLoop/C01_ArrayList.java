...
public class C01_ArrayList {
    public static void main(String[] args) {
        ...
        System.out.println("Tam bolenlerini listelemek icin pozitif tam sayi girin");
     ...
     public static List<Integer> tamBolenlerListesiOlustur(int girilenSayi){
        ...
        List<Integer> tamBolenleriListesi=new ArrayList<>();

         for (int i = 1; i <=girilenSayi ; i++) {
             if (girilenSayi%i==0){
                 tamBolenleriListesi.add(i);
             }

         }

         return tamBolenleriListesi;
