...
public class C03_Queue {
    public static void main(String[] args) {
        ...
        System.out.println(harfler); // [B, K] silmedi
    ...
    //    System.out.println(karakterler.element()); // NoSuchElementException
     ...
     //   System.out.println(karakterler.remove());  // NoSuchElementException
        ...
        //add ile offer araindaki fark offer varsa kapasiteyi kontrol eder, uygunsa ekler.
        //add kapasiteye bakmaksizin direkt ekler
