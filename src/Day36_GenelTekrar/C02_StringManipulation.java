...
public class C02_StringManipulation {
    public static void main(String[] args) {
        ...
        //verilen bir cumlede istenen kelimenin kac kere gectigini bulup yazdirin
        //bir method olusturalim

        String cumle="Java basladi ve biti . Java meger ne guzelmis .Ne phyton ne C , Java en iyisi";
